...
def interQ_detect(document,col):
    q1 = recup(col).quantile(0.25)
    q3 = recup(col).quantile(0.75)
...
def appeler_anomalie2(document,col):
    j,i=interQ_detect(document,col)
